...
"""
PRESETS = {
    "safe": dict(speed="safe", sleep_min=6, sleep_max=15, per_keyword=10, comments_count=30),
    "ultra": dict(speed="safe", sleep_min=12, sleep_max=28, per_keyword=10,
                  comments_count=30, kw_gap=180),
    "fast": dict(speed="fast", sleep_min=2, sleep_max=6, per_keyword=10, comments_count=30),
}
